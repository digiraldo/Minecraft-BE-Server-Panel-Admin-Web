...
$disallowed_extensions = ['psd'];  // debe ser una matriz. Extensiones no permitidas para cargar
$hidden_extensions = ['psd']; // debe ser una matriz de extensiones de archivo en minúsculas. Extensiones ocultas en el índice del directorio
