...
if [[ $(find "SetupMinecraft.sh" -mtime +7 -print) ]]; then
  echo "Realizando autoactualización SetupMinecraft..."
  wget -O SetupMinecraft.sh https://raw.githubusercontent.com/digiraldo/Minecraft-BE-Server-Panel-Admin-Web/master/SetupMinecraft.sh
  chmod +x SetupMinecraft.sh
