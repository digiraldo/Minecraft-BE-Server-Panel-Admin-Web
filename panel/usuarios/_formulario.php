        ...
        <div class="card-header">
            ...
            <form action="" method="POST" role="form">
                <legend></legend>
                        ...
                        <label for="my-input">Nivel de Permiso</label>
                        <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01"><i class="fas fa-address-book"> <?php echo $usuarioN['permission'] ?></b></i></label>
                        </div>
